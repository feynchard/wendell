...
public class CreateTodoService implements WebService {
	...
	public void action(RequestParameterEditing editing, HttpServletResponse resp)
		...
		Todo todo = new Todo(Key.create(User.class, editing.getLoginUser()
				.getId()), editing.getTitle(), null, null, null, Key.create(
				Directory.class, editing.getDirectory().getId()), true, false);
